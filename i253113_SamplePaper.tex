...
\]
 ...
 \subsection{Task 2B: Compute the Loss}
\textbf{Step 1 - Compute individual squared errors\\ \\ }
\textbf{Sample $s^{(1)}$}
...
\textbf{Step 2 - Sum and average\\ }
\[
SSE = (0.2069)+(0.2071)+(0.2930)
\]
\[
\mathbf{SSE = 0.7070}
\]
...
\[
L_{MSE} = \frac{0.7070}{3}
\]

\[
\mathbf{Final Loss = 0.2356}
\]

%%%% c %%%%%
\subsection{Task 2C: Interpret Your Loss}
