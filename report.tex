...
\begin{abstract}
This project presents the implementation of a Multilayer Perceptron (MLP) from scratch using NumPy. The main objective is to understand how neural networks work by manually implementing forward propagation, loss calculation, and backpropagation. The model is trained using mini-batch gradient descent on the MNIST dataset. The results show that the loss decreases over time that the model is able to classify handwritten digits with reasonable accuracy.
...
\section{Conclusion}
In this project, a neural network was implemented from scratch. This helped in understanding forward propagation, backpropagation, and gradient descent.
